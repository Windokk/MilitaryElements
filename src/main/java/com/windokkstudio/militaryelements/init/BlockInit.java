...
import com.windokkstudio.militaryelements.blocks.BarbedWire;
...
public class BlockInit {
    ...
    public static final RegistryObject<Block> BARBED_WIRE = register("barbed",
            () -> new BarbedWire(), new Item.Properties().tab(MilitaryElements.TAB));
